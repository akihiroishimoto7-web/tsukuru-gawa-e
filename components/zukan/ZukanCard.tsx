...
export function ZukanCard({ item, index }: { item: ZukanItem; index: number }) {
  ...
  return (
    <motion.article
      ...
      className="group flex h-full flex-col rounded-2xl border border-white/10 bg-white/[0.03] p-6 transition-all hover:-translate-y-1 hover:border-white/25 hover:bg-white/[0.06] card-glow"
    >
