...
export const resultTypes: Record<ResultTypeId, ResultType> = {
  practical: {
    ...
    inThreeYears:
      "あなたの工夫が、同じ現場の人にも使われている。『助かる』の声が、続ける理由になっています。",
    roadmap: [
  ...
  education: {
    ...
    inThreeYears:
      "あなたの教材で『わかった』と言う人が、少しずつ増えている。教えることが、もっと楽しくなっています。",
    roadmap: [
  ...
  media: {
    ...
    inThreeYears:
      "あなたの発信を頼りにする人が現れている。難しかったことを、誰かに届けられる人になっています。",
    roadmap: [
  ...
  founder: {
    ...
    inThreeYears:
      "一人で始めたものに、使ってくれる人がついている。『これ、仕事です』と言える小さな何かが育っています。",
    roadmap: [
  ...
  explorer: {
    ...
    inThreeYears:
      "気づけば、いくつも作ってきた。『つくる側』でいることが、もう当たり前の自分になっています。",
    roadmap: [
